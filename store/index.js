export const state = () => ({
  ...
  news: [
    {id: 1, img: 'news/bonuses.jpg', title: 'Бонусная карта', date: '01.01.2022', description: 'Карта «Пятёрочка» от «Почта Банка» — это неименная банковская карта национальной системы платежных карт «Мир»/Visa Classic, которая позволит вам еще больше экономить на покупках в магазинах «Пятёрочка», а также получать ежемесячно дополнительный доход в виде процентов на остаток по счёту карты.'},
    {id: 2, img: 'news/encanto.jpg', title: '"Энканто" завоевал "Оскар"!', date: '25.02.2022', description: 'Кинопремию «Оскар» в номинации «Лучший полнометражный мультфильм» получил «Энканто». Мультфильм кинокомпании Disney рассказывает историю семьи Мадригаль, которая проживает в волшебном доме в горах Колумбии. У каждого в семействе есть магические способности кроме юной Мирабель. Однако именно ей придется спасать своих близких, когда их дому грозит опасность.'},
    {id: 3, img: 'news/batman.jpg', title: 'Бэтмена не будет! Расходимся...', date: '03.03.2022', description: '«Бэтмен» (Warner Bros.), премьера которого должна была состояться уже завтра, не выйдет в российских кинотеатрах. То же самое касается мультфильма Disney «Я краснею» (релиз был запланирован на 10 марта). Sony отменила премьеру «Морбиуса» в России (24 марта).'}
  ].reverse()
})
